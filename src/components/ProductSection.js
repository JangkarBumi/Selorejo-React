    ...
    <div>
      <section className="product-section">
        ...
        <img
          ...
          src={require("../images/product-img.png")}
          alt=""
        />
        ...
        <div className="desc-text">
          ...
          <div className="key-value">
            <ul>
              <hr />
              <li>
                Artisan Employment <span className="value">54 jobs</span>
              </li>
              <hr />
              <li>
                Partnership <span className="value">Randall Armstrong</span>
              </li>
              <hr />
              <li>
                In Collab <span className="value">Augusta Mendoza</span>
              </li>
              <hr />
            </ul>
            <p>SIZES</p>
            ...
            <div className="panel">
              ...
              <p>
                ...
                delicate machine wash with cold water, or handwash cold for best
                results. Do not tumble dry. Line dry inside out. Iron inside out
