    ...
    <div>
      <section className="product-desc">
        <img
          ...
          src={require("../images/product-desc-img.png")}
          alt=""
        />
            ...
            <ul>
              <li>
                <img
                  ...
                  src={require("../images/3-img-article-1.png")}
                  alt=""
                />
              ...
              <li>
                <img
                  className="product-video-thumb"
                  src={require("../images/3-img-article-2.png")}
                  alt=""
                />
                <span className="video-title">Lorem ipsum dolor sit amet</span>
              </li>
              ...
              <li>
                <img
                  className="product-video-thumb"
                  src={require("../images/3-img-article-3.png")}
                  alt=""
                />
                <span className="video-title">Lorem ipsum dolor sit amet</span>
              </li>
